...
![Image of homepage WAVE validation](docs/evidence/testingevidence/wavevalidations/indexwavevalidation2.png)

You will notice the two alerts noted by WAVE in the screenshot above. These relate to the links to Blogger articles, which, as they do not exist, link to Blogger's homepage. As they duplicate, they are noted as Alerts by WAVE. See below.
